...
mixin Scroll2TopLogicMixin on GetxController {
  ...
  bool get shouldDisplayFAB =>
      preferenceSetting.hideScroll2TopButton.value ==
          Scroll2TopButtonModeEnum.never ||
      (preferenceSetting.hideScroll2TopButton.value ==
              Scroll2TopButtonModeEnum.scrollDown &&
          scroll2TopState.isScrollingDown) ||
      (preferenceSetting.hideScroll2TopButton.value ==
  ...
  void onInit() {
    super.onInit();
    scroll2TopSettingWorker = ever(preferenceSetting.hideScroll2TopButton,
        (_) => updateSafely([scroll2TopButtonId]));
  }
  ...
  bool onUserScroll(UserScrollNotification notification) {
    ...
    if (preferenceSetting.hideScroll2TopButton.value ==
            Scroll2TopButtonModeEnum.never ||
        preferenceSetting.hideScroll2TopButton.value ==
            Scroll2TopButtonModeEnum.always) {
      return false;
    }
