...
import 'package:jhentai/src/widget/nh_mouse_button_listener.dart';
...
import '../../widget/nh_image.dart';
import '../../widget/nh_keyboard_listener.dart';
import '../../widget/nh_read_page_stack.dart';
        ...
        child: AppBar(
          ...
          actions: [
            if (GetPlatform.isDesktop)
              ElevatedButton(
                child:
                    const Icon(Icons.help, color: UIConfig.readPageButtonColor),
                onPressed: () => toast(
