...
import 'package:jhentai/src/utils/nh_executor.dart';
...
class ReadPageLogic extends GetxController {
  ...
  void onReady() {
    ...
    displayFirstPageAloneListener =
        ever(readSetting.displayFirstPageAlone, (value) {
  ...
  void listen2VolumeKeys() {
    ...
    volumeService
        .setInterceptVolumeEvent(readSetting.enablePageTurnByVolumeKeys.value);
  }
  ...
  String getSuperResolutionProgress() {
    ...
    SuperResolutionInfo? superResolutionInfo =
        superResolutionService.get(gid, SuperResolutionType.gallery);
