  ...
  MobileLayoutPageV2State() {
    icons = [
      ...
      TabBarIcon(
        ...
        selectedIcon:
            const Icon(Icons.search, shadows: [Shadow(blurRadius: 2)]),
      ...
      TabBarIcon(
        ...
        page: () => PopularPage(
            showMenuButton: true, showTitle: true, name: 'popular'.tr),
        scrollController: () =>
      ...
      TabBarIcon(
        ...
        page: () => FavoritePage(
            showMenuButton: true, showTitle: true, name: 'favorite'.tr),
        scrollController: () =>
      ...
      TabBarIcon(
        ...
        selectedIcon:
            const Icon(Icons.history, shadows: [Shadow(blurRadius: 2)]),
        unselectedIcon: const Icon(Icons.history_outlined),
        page: () => HistoryPage(
            showMenuButton: true, showTitle: true, name: 'history'.tr),
        scrollController: () =>
