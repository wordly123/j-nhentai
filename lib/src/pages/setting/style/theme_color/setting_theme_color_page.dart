        ...
        children: [
          Expanded(
            child: Row(
              ...
              children: [
                IconButton(
                  icon: Icon(selectedBrightness == Brightness.light
                      ? Icons.sunny
                      : Icons.nightlight),
                  onPressed: () {
                ...
                IconButton(
                  ...
                  onPressed: () async {
                    ...
                    if (selectedBrightness == Brightness.light) {
                      ...
                      Get.rootController.theme = ThemeConfig.theme(
                          styleSetting.lightThemeColor.value, Brightness.light);
                    } else {
                      styleSetting.saveDarkThemeColor(newColor);
                      Get.rootController.darkTheme = ThemeConfig.theme(
                          styleSetting.darkThemeColor.value, Brightness.dark);
                    }
...
class _ColorSettingDialog extends StatefulWidget {
  ...
  const _ColorSettingDialog(
      {Key? key, required this.initialColor, required this.resetColor})
      : super(key: key);
