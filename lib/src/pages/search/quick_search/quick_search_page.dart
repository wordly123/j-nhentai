...
class QuickSearchPage extends StatelessWidget {
  ...
  const QuickSearchPage({Key? key, this.automaticallyImplyLeading = false})
      : super(key: key);
      ...
      body: GetBuilder<QuickSearchService>(
        builder: (_) {
          List<MapEntry<String, SearchConfig>> entries =
              quickSearchService.quickSearchConfigs.entries.toList();
              ...
              children: [
                ListTile(
                  ...
                  trailing: IconButton(
                    ...
                    onPressed: () => quickSearchService
                        .handleUpdateQuickSearch(entries[index]),
                  ).marginOnly(right: GetPlatform.isDesktop ? 24 : 0),
                  onTap: () => newSearch(
                      rewriteSearchConfig: entries[index].value,
                      forceNewRoute: true),
                ),
