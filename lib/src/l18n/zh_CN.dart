...
class zh_CN {
  static Map<String, String> keys() {
    return {
      ...
      'nhentai': 'NHentai',
      'nhentaiAuth': 'NHentai 认证',
      'useApiKeyOrUserTokenHint': '使用你 nhentai 账号中的 API Key 登录。',
      'nhApiKeyTutorial':
          '教程：\n1. 手动登录 nhentai 网站；\n2. 访问 https://nhentai.net/user/settings#profile,apikeys；\n3. 在 apikeys 页面创建自己的 API Key；\n4. 将 API Key 粘贴到下方输入框并保存。',
      'apiKeyLabel': 'API Key',
      'apiKeyOptionalHint': '请输入你的 API Key',
      'apiKeyRequiredHint': '请输入你的 API Key',
      'userToken': 'User Token',
      'userTokenOptionalHint': '可选，仅填写 API Key 也可登录',
      'saveAuth': '保存认证',
      'saveApiKey': '保存 API Key',
      'pleaseInputApiKeyOrUserToken': '请输入 API Key 或 User Token',
      'pleaseInputApiKey': '请输入 API Key',
      'nhUser': 'NH 用户',
      'legacySessionActive': '当前为旧版会话登录状态。',
      'editNhAuth': '编辑 NH 认证',
      'updateApiKeyOrUserToken': '更新 API Key / User Token',
      'updateApiKey': '更新 API Key',
      'nhentaiApiDocs': 'NHentai API 文档',
      'nhWebLogin': '账号密码登录（网页）',
      'nhWebLoginOpenHint': '已打开网页登录，请完成登录后等待自动回填',
      ...
      'galleryUrl': '画廊链接',
      'galleryId': '作品编号',
      'nhGalleryIdHint': '输入 nhentai 作品编号',
      'invalidNhGalleryId': '请输入有效的 nhentai 作品编号',
      'title': '标题',
      'japaneseTitle': '日文标题',
      'category': '类别',
      'publishTime': '发布时间',
      ...
      'nhentaiSearchLanguage': 'NHentai 全局语言筛选',
      'nhentaiSearchLanguageHint':
          '默认不限制。仅在未手动指定语言时，为首页、搜索、热门与排行榜追加 language:*',
      'japanIpRiskHint': '检测到当前网络出口疑似为日本 IP 或日本节点，请不要使用日本 IP，以免导致访问异常。',
      'showComments': '显示画廊评论',
