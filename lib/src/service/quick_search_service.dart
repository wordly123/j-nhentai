...
class QuickSearchService extends GetxController
  ...
  void applyBeanConfig(String configString) {
    ...
    quickSearchConfigs = LinkedHashMap.from(
  ...
  Future<void> reOrderQuickSearch(int oldIndex, int newIndex) async {
    ...
    List<MapEntry<String, SearchConfig>> entries =
        quickSearchConfigs.entries.toList();
  ...
  Future<void> handleUpdateQuickSearch(
      MapEntry<String, SearchConfig> oldConfig) async {
    ...
    if (oldConfig.key != quickSearchName &&
        quickSearchConfigs.containsKey(quickSearchName)) {
