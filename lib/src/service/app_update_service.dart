...
class ClearLegacyBlockRulesHandler implements UpdateHandler {
  @override
  List<JHLifeCircleBean> get initDependencies => [localBlockRuleService];
  ...
  @override
  Future<void> onInit() async {
    log.info('ClearLegacyBlockRulesHandler onInit');
    await BlockRuleDao.deleteAllBlockRules();
  }
