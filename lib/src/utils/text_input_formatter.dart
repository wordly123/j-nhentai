...
class DoubleRangeTextInputFormatter extends TextInputFormatter {
  ...
  DoubleRangeTextInputFormatter({this.minValue, this.maxValue})
  ...
  TextEditingValue formatEditUpdate(
    ...
    if (newValue.text.isEmpty ||
        (minValue != null && minValue! < 0 && newValue.text == '-')) {
      return newValue;
    }

    double newNum =
        double.tryParse(newValue.text) ?? minValue ?? maxValue ?? -100;
...
class IntRangeTextInputFormatter extends TextInputFormatter {
  ...
  IntRangeTextInputFormatter({this.minValue, this.maxValue})
      : assert(minValue != null || maxValue != null);
