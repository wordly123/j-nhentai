...
class BlockRuleDao {
  ...
  static Future<List<BlockRuleData>> selectBlockRulesByTarget(int target) {
    return (appDb.select(appDb.blockRule)
          ..where((r) => r.target.equals(target)))
        .get();
  }
  ...
  static Future<int> deleteBlockRuleByGroupId(String groupId) {
    return (appDb.delete(appDb.blockRule)
          ..where((r) => r.groupId.equals(groupId)))
        .go();
  }

  static Future<int> deleteAllBlockRules() {
    return appDb.delete(appDb.blockRule).go();
  }
