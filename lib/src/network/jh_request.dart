...
class JHRequest with JHLifeCircleBeanErrorCatch implements JHLifeCircleBean {
  ...
  List<JHLifeCircleBean> get initDependencies =>
      super.initDependencies..add(ehRequest);
  ...
  Future<T> requestConfigByShareCode<T>(
      {required String shareCode, HtmlParser<T>? parser}) async {
    Response response = await _dio.get(
  ...
  Future<T> requestDeleteConfig<T>(
      {required int id, HtmlParser<T>? parser}) async {
    Response response = await _dio.post(
