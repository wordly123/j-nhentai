...
class EHCacheManager extends Interceptor {
  ...
  void onRequest(
    ...
    CacheResponse? cacheResponse = await _getCacheStore(cacheOptions)
  ...
  bool _shouldSkipRequest(
      RequestOptions requestOptions, CacheOptions cacheOptions) {
  ...
  Future<void> _saveResponse(
      Response response, CacheOptions cacheOptions) async {
    CacheResponse cacheResponse =
        CacheResponse.fromResponse(response, cacheOptions);
  ...
  Future<CacheResponse> _updateCacheResponse(
      CacheResponse cacheResponse, CacheOptions cacheOptions) async {
...
class CacheOptions {
  ...
  static get cacheOptions => CacheOptions(
      policy: CachePolicy.cache, expire: networkSetting.pageCacheMaxAge.value);
  ...
  CacheOptions copyWith(
      {CachePolicy? policy, Duration? expire, SqliteCacheStore? store}) {
    return CacheOptions(
  ...
  static CacheResponse fromResponse(Response response, CacheOptions options) {
    return CacheResponse(
      content: _serializeContent(
          response.requestOptions.responseType, response.data),
      ...
      url: response.requestOptions.extra[EHCacheManager.realUriExtraKey] ??
