...
class EHAppPasswordSettingDialog extends StatefulWidget {
  ...
  @override
  State<EHAppPasswordSettingDialog> createState() =>
      _EHAppPasswordSettingDialogState();
}

class _EHAppPasswordSettingDialogState
    extends State<EHAppPasswordSettingDialog> {
