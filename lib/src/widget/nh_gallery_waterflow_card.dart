...
import 'nh_gallery_list_card_.dart';
import 'nh_image.dart';
...
class EHGalleryWaterFlowCard extends StatelessWidget {
  ...
  bool get _shouldShowRating => gallery.rating > 0 || gallery.hasRated;
      ...
      children: [
        ...
        Column(
          ...
          children: [
            Row(
              children: [
                if (_shouldShowRating) _buildRatingBar(context),
