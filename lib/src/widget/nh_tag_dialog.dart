...
import 'package:jhentai/src/widget/nh_tag_set_dialog.dart';
import 'package:jhentai/src/widget/nh_warning_image.dart';
...
class _EHTagDialogState extends State<EHTagDialog> with LoginRequiredMixin {
  ...
  Future<bool> handleAddWatchedTag(bool watch) async {
    if (!userSetting.hasLoggedIn()) {
      showLoginToast();
      return false;
    }
