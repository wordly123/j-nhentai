...
class EHGalleryDetailDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final String publishTime = preferenceSetting.showUtcTime.isTrue
        ? galleryDetail.publishTime
        : DateUtil.transformUtc2LocalTimeString(galleryDetail.publishTime);
    ...
    return SimpleDialog(
      ...
      children: [
        ...
        if (galleryDetail.ratingCount > 0)
          _Item(
              name: ('ratingCount'.tr),
