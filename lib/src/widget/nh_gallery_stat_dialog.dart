...
class _AllTimeTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Text('${'totalVisits'.tr}: ${galleryStats.totalVisits}',
          ...
          rows: <DataRow>[
            DataRow(
              cells: <DataCell>[
                ...
                DataCell(Center(
                    child: Text(galleryStats.allTimeRanking == null
                        ? '-'
                        : '#${galleryStats.allTimeRanking}'))),
                DataCell(Center(
                    child: Text(galleryStats.allTimeScore == null
                        ? '-'
            ...
            DataRow(
              cells: <DataCell>[
                ...
                DataCell(Center(
                    child: Text(galleryStats.yearRanking == null
                        ? '-'
                        : '#${galleryStats.yearRanking}'))),
                DataCell(Center(
                    child: Text(galleryStats.yearScore == null
                        ? '-'
            ...
            DataRow(
              cells: <DataCell>[
                ...
                DataCell(Center(
                    child: Text(galleryStats.monthRanking == null
                        ? '-'
                        : '#${galleryStats.monthRanking}'))),
                DataCell(Center(
                    child: Text(galleryStats.monthScore == null
                        ? '-'
            ...
            DataRow(
              cells: <DataCell>[
                ...
                DataCell(Center(
                    child: Text(galleryStats.dayRanking == null
                        ? '-'
                        : '#${galleryStats.dayRanking}'))),
                DataCell(Center(
                    child: Text(galleryStats.dayScore == null
                        ? '-'
