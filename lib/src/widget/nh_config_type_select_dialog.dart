...
class EHConfigTypeSelectDialog extends StatefulWidget {
  ...
  @override
  State<EHConfigTypeSelectDialog> createState() =>
      _EHConfigTypeSelectDialogState();
}

class _EHConfigTypeSelectDialogState extends State<EHConfigTypeSelectDialog> {
  List<CloudConfigTypeEnum> selected = [
    ...CloudConfigTypeEnum.values.where((e) => e != CloudConfigTypeEnum.blockRules)
  ];
    ...
    return AlertDialog(
      ...
      content: Column(
        ...
        children: CloudConfigTypeEnum.values
            .where((e) => e != CloudConfigTypeEnum.blockRules)
