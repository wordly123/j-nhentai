...
class EHGroupNameSelector extends StatefulWidget {
  ...
  const EHGroupNameSelector(
      {Key? key, this.currentGroup, required this.candidates, this.listener})
      : super(key: key);
      ...
      child: TextField(
        decoration: InputDecoration(
          ...
          labelStyle: const TextStyle(
              fontSize: UIConfig.groupSelectorTextFieldLabelTextSize),
        ),
        style:
...
class GroupChip extends StatefulWidget {
  ...
  const GroupChip(
      {Key? key, required this.text, required this.selected, this.onTap})
      : super(key: key);
